...
require '../../login/connection.php';
    ...
    echo $lokasi = "../../admin/pakar/pendaftaran/" . $noreg[0] . "_" . "$nama";
    if (!is_dir($lokasi)) {
        mkdir($lokasi, 0755);
    }
    ...
    $sql_query .= "dir = '$lokasi', ";

    // FILE KETERANGAN POLISI
    if (isset($_FILES)) {
        $polisi = ($_FILES['polisi']['tmp_name'] != "") ? 'file_kepolisian.' . array_pop(explode(".", $_FILES["polisi"]["name"])) : "";
        ...
        // FILE SIM
        $sim = ($_FILES['sim']['tmp_name'] != "") ? 'file_sim.' . array_pop(explode(".", $_FILES["sim"]["name"])) : "";
        ...
        // FILE STNK
        $stnk = ($_FILES['stnk']['tmp_name'] != "") ? 'file_stnk.' . array_pop(explode(".", $_FILES["stnk"]["name"])) : "";
        ...
        // FIE KTP
        $ktp = ($_FILES['ktp']['tmp_name'] != "") ? 'file_ktp.' . array_pop(explode(".", $_FILES["ktp"]["name"])) : "";
        ...
        // FILE KK
        $kk = ($_FILES['kk']['tmp_name'] != "") ? "file_kk." . array_pop(explode(".", $_FILES["kk"]["name"])) : "";
        ...
        // FILE AKTE NIKAH
        $akte_nikah = ($_FILES['akte_nikah']['tmp_name'] != "") ? "file_akta_nikah." . array_pop(explode(".", $_FILES["akte_nikah"]["name"])) : "";
        ...
        // FILE AKTE KELAHIRAN
        $akte_kelahiran = ($_FILES['akte_lahir']['tmp_name'] != "") ? "file_akta_lahir." . array_pop(explode(".",  $_FILES["akte_lahir"]["name"])) : "";
        ...
        $diagnosis = ($_FILES['diagnosis']['tmp_name'] != "") ? "file_diagnosis_dokter." . array_pop(explode(".", $_FILES["diagnosis"]["name"])) : "";
        ...
        // FILE AHLI WARIS
        $ahli_waris = ($_FILES['ahli_waris']['tmp_name'] != "") ? "file_ahli_waris." . array_pop(explode(".", $_FILES["ahli_waris"]["name"])) : "";
        ...
        $kwitansi = ($_FILES['kwitansi']['tmp_name'] != "") ? "file_kwitansi_dokter." . array_pop(explode(".", $_FILES["kwitansi"]["name"])) : "";
        ...
        $kwitansi_apotek = ($_FILES['kwitansi']['tmp_name'] != "") ? "file_kwitansi_apotek." . array_pop(explode(".", $_FILES["kwitansi_apotek"]["name"])) : "";
        ...
        $kwitansi_rawat = ($_FILES['kwitansi_rawat']['tmp_name'] != "") ? "file_kwitansi_rawat." . array_pop(explode(".", $_FILES["kwitansi_rawat"]["name"])) : "";
        ...
        if ($j != 0) {
            ...
            for ($i = 0; $i < $j; $i++) {
                ...
                $dokumen_lain[$i] = ($_FILES['dokumen_lain' . ($i + 1)]['tmp_name'] != "") ? "file_dokumen_tambahan" . ($i + 1) . "." . array_pop(explode(".", $_FILES["dokumen_lain" . ($i + 1)]["name"])) : "";

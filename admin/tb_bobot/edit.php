...
if ($_POST['rowid']) {
	$id = $_POST['rowid'];
	$sql = "SELECT * FROM tb_bobot WHERE id_bobot ='$id'";
...
<form action="aksiedit.php" method="post" role="form">
    <div class="form-group field item row">
        ...
        <div class="col-md-6 col-sm-6">
            <input type="hidden" name="id" value="<?php echo $baris['id_bobot'] ?>">
            <input type="text" name="nilai" value="<?php echo $baris['bobot'] ?>" required="required"
    ...
    <div class="form-group field item row">
        ...
        <div class="col-md-6 col-sm-6">
            <input type="text" name="status" value="<?php echo $baris['status_bobot'] ?>" required="required"
                class="form-control has-feedback-left">

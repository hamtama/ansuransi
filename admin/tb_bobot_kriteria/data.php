        ...
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                ...
                <button class="btn btn-success tambah" id="1"><i class="fa fa-plus">
                        Tambah</i></button>
                <a href="normalisasi.php?id=submit" class="btn btn-success normalisasi" id="1"><i class="fa fa-refresh">
                        Normalisasi</i></a>
                <div class="x_content">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-box">
                                <table id="datatable-responsive"
                                    ...
                                    <tbody>
                                        <?php
                                        $no = 1;
                                        $query = "SELECT * FROM tb_bobot_kriteria a INNER JOIN tb_skala b ON b.id_skala = a.id_skala";
                                        ...
                                        <tr>
                                            <td style="width:10%">
                                                <a class="btn btn-warning btn-xs" data-toggle="modal" href="#myModal"
                                                    ...
                                                    data-id="<?= $row['id_bobot_kriteria'] ?>"><i
                                                        class="fa fa-pencil"></i></a>
                                                <button class="btn btn-danger btn-xs"
                                                    onclick="javascript:delete_id(<?= $row['id_bobot_kriteria'] ?>)"><i
    ...
    $('.tambah').click(function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('.modal-title').text("Tambah Data Bobot Kriteria");
            }
        });
    });
});
...
$(document).ready(function() {
    $('#myModal').on('show.bs.modal', function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                $('.fetched-data').html(data); //menampilkan data ke dalam modal
                $('.modal-title').text("Edit Data Data Kriteria");
            }
        });
    });
});

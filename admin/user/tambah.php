                        ...
                        <div class="col-sm-12">
                            <form role="form" class=""  action="aksitambah.php" method="post">
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input data-width="100" class="toggle-class"  type="checkbox" data-toggle="toggle" data-on="Active" data-off="Deactive" data-onstyle="success" data-offstyle="danger" id="status">
                                    </div>
                                </div>

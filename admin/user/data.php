    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                ...
                <button class="btn btn-primary" onclick="javascript:window.location=('tambah.php')"> <i
                                        ...
                                        <tr>
                                            <td style="width:10%">
                                                <a class="btn btn-warning btn-xs" data-toggle="modal" href="#myModal"
                                                    id="custId" data-target="#myModal" data-id="<?=$row['id'] ?>"><i
                                                        class="fa fa-pencil"> Edit</i></a>
                                                <button class="btn btn-danger btn-xs"
                                                    onclick="javascript:delete_id(<?=$row['id']?>)"><i
                                            ...
                                            <td>
                                                ...
                                                <input data-width="100" class="toggle-class" name="toggle-class"
                                                    id="toggle-class" type="checkbox" data-toggle="toggle"
                                                    data-on="Active" value="<?php echo $row['id']; ?>"
                                                ...
                                                <input class="form-control" type="hidden" name="active"
                                                    data-id="<?php echo $row['id']; ?>" id="hidden_edit"
